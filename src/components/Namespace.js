    ...
    <>
     <StyledNamespace animate={controls} ref={ref} id="about" variants={slideAnim.right}>
        ...
        <p>
            ...
            <Class>
                <span>public class</span> Brahim : Person<br />
                &#123; <br/>
                <Properties>
                    <span>public int</span>  Age &#123; get; &#125; = 25;<br/>
                    <span>public string</span> City &#123; get; &#125; = "MA, Tetouan";<br/>
                    <span>public string</span> Studying &#123; get; &#125; = "1337";<br/>
                </Properties>
                &#125;
            </Class>
        &#125;
